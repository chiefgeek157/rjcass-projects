                ...
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value">${role.id}</td>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value">${role.name}</td>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value">${role.description}</td>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value">${role.people}</td>
